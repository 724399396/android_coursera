...
public class TestBookmarks extends
	...
	public void testRun() {
		...
		assertTrue(
				...
				solo.waitForActivity(course.labs.permissionlab.ActivityLoaderActivity.class, delay));

		// Click on Bookmarks Activity
		solo.clickOnView(solo
				.getView(course.labs.permissionlab.R.id.start_bookmarks_button));
		...
		assertTrue(
				...
				solo.waitForActivity(course.labs.permissionlab.BookMarksActivity.class, delay));
		
		// ================ Section Two ===============
		// Click on Get Bookmarks
		solo.clickOnView(solo
				.getView(course.labs.permissionlab.R.id.get_bookmarks_button));
