...
public class DownloaderTaskFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Prepare them fro use with DownloaderTask.
        ArrayList<Integer> rIds = getArguments().getIntegerArrayList(MainActivity.TAG_FRIENDS_RES_IDS);

        // TODO: start the DownloaderTask
        downloaderTask.execute(rIds.toArray(new Integer[rIds.size()]));
    }
    ...
    // TODO: Implement an SyncTask subclass called DownloaderTask.
    // THis class must use the downloadTweets method(currently commented
    // out). Ultimately, it must also pass newly available data back to
    // the hosting Activity using the DownloadFinishedListener interface

    public class DownloaderTask extends AsyncTask<Integer, Void, Void> {
        @Override
        protected Void doInBackground(Integer... params) {
            mCallback.notifyDataRefreshed(downloadTweets(params));
            return null;
        }
    }
    ...
    private void notify(final boolean success) {
        ...
        // Sends an ordered broadcast to determine where MainActivity is
        ...
        mContext.sendOrderedBroadcast(new Intent(
                ...
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        if (getResultCode() != MainActivity.IS_AVIVE) {
                            ...
                            // Uses R.layout.customer_notification for the
                            // layout of the notification View. The xml
                            // file is in res/layout/customer_notification.xml
                            RemoteViews mContentView = new RemoteViews(
                                    mContext.getPackageName(),
                                    R.layout.customer_notification);
